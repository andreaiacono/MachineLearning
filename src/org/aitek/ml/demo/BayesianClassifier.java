...
public class BayesianClassifier {
	...
	public static void main(String[] args) throws Exception {
		...
		classifier.trainFromTweetsFile("resources/classifier/tweets_train.txt");
		// classifier.train("jdbc:mysql://localhost:3306/db_name", "user", "password",
		// "SELECT * FROM data");

		// classify some new tweets
		classifier.classifyMessage("RT @SLRCameraTree: Canon EOS Digital Rebel T2i 18MP w/ Full HD 1080p Video, 3.7... http://t.co/a5qFtfvdkB &lt;&lt;== #Deal #SLR #Cameras #Nikon #Canon #Sony #DSLR");
